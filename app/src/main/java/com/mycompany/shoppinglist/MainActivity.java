...
import com.mycompany.shoppinglist.db.TaskContract;
import com.mycompany.shoppinglist.db.TaskDbHelper;
        ...
        switch (item.getItemId()) {
            case R.id.action_add_task:
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        ...
                        .setMessage("What do you need to add to your shopping list?")
